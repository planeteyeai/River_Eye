...
const LIMITS = [
  'Of the nine themes above, hydrology opens the reach digital twin. Water quality and salinity intrusion open TSS, NDCI, NDWI, WST and BOD–COD. The rest describe intended scope, not shipped screens.',
